...
print ("") 
print ("Table 5a - Sepal Length")
print (irisdataset.groupby(['class']).agg(['mean', 'median' , 'std', 'min', 'max']).sepal_length)
print ("")
print ("Table 5b - Sepal Width")
print (irisdataset.groupby(['class']).agg(['mean', 'median' , 'std', 'min', 'max']).sepal_width)
print ("")
print ("Table 5c - Petal Length")
print (irisdataset.groupby(['class']).agg(['mean', 'median' , 'std', 'min', 'max']).petal_length)
print ("")
print ("Table 5d - Petal Width")
print (irisdataset.groupby(['class']).agg(['mean', 'median' , 'std', 'min', 'max']).petal_width)
print ("")
print ("")
#print ("Table 6 -  Average (Mean) Length/Width of Petals & Sepals by Species")
#print ("") 
#print (irisdataset.groupby(['class']).mean())
#print ("")
#print ("")
#print ("Table 7 -  Standard Deviation of Length/Width of Petals & Sepals by Species")
#print ("")
#print (irisdataset.groupby(['class']).std())
#print ("")
#print ("")
#print ("Table 8 -  Minimum Value of Petals & Sepals by Species")
#print ("")
#print (irisdataset.groupby(['class']).min())
#print ("")
#print ("")
#print ("Table 9 -  Maximum Value of Petals & Sepals by Species")
#print ("")
#print (irisdataset.groupby(['class']).max())
#print ("")
#print ("")
